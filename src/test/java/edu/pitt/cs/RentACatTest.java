...
public class RentACatTest {
	...
	public void setUp() throws Exception {
		...
		//Used to test on BuggyRentACat (should fail all except for getCat tests for an 11/13 failure rate)
	...
	public void testListCatsNumCats3() {
		...
		String c1_str = "ID " + c1.getId() + ". " + c1.getName();
		String c2_str = "ID " + c2.getId() + ". " + c2.getName();
		String c3_str = "ID " + c3.getId() + ". " + c3.getName();

		Mockito.when(c1.toString()).thenReturn(c1_str);
		Mockito.when(c2.toString()).thenReturn(c2_str);
		Mockito.when(c3.toString()).thenReturn(c3_str);
